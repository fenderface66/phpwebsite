        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#posts_dropdown"><i class="fa fa-fw fa-arrows-v"></i> Portfolio <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="posts_dropdown" class="collapse">
                            <li>
                                <a href="case_studies.php?source=view_all_cases">View Case Studies</a>
                            </li>
                            <li>
                                <a href="case_studies.php?source=add_case">Add Case Study</a>
                            </li>
                        </ul>
                    </li>
                    <li>
